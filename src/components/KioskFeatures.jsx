  ...
  const contentData = [
    {
      ...
      description:
        ...
        image: "../src/assets/effortless-kiosk-deployement-image.webp",
    },
    {
      ...
      description:
        ...
        image: "../src/assets/customized-interface-image.webp",
    },
    {
      ...
      description:
        ...
        image: "../src/assets/power-up-protection-image.webp",
    },
    {
      ...
      description:
        ...
        image: "../src/assets/secure-app-ecosystem.webp",
    },
    {
      ...
      description:
        ...
        image: "../src/assets/easy-to-use-interface-image.webp",
    },
  ];
  ...
  return (
    <section className=" py-10 px-4 md:px-20">
      <h2 className="text-2xl md:text-4xl font-semibold text-center mb-20 text-gray-900">
        What additional possibilities does the <br className="hidden md:block" />
        Kiosk mode offer?
      </h2>
